...
var index$1 = new IntersectionManager();
...
class AudioManager {
     ...
     * @return {AudioManager} AudioManager
     */
    setAudioOption(option = { mixWithOther: true }) {
    ...
    play(option = {
        ...
        if (!this._audios[option.src]) {
            ...
            this._audios[option.src] = {
                playIndex: 0,
                audioList: Array.from(Array(option.concurrentNum > this._maxConcurrentNum
        ...
        // 重置音效到起始位置
        this._audios[option.src].audioList[this._audios[option.src].playIndex].seek(0);
        // 播放音频
        this._audios[option.src].audioList[this._audios[option.src].playIndex].play();
        // 更新当前可进行播放的音频实例下标
        this._audios[option.src].playIndex += 1;
        if (this._audios[option.src].playIndex >
...
var index = new AudioManager();

exports.ActionManager = index$5;
exports.AudioManager = index;
exports.DialogManager = index$4;
exports.EventManager = index$3;
exports.IntersectionManager = index$1;
exports.TimeManager = index$2;
